...
# python -m machine-learning-api run
# ^-- I actually had to run this with debug off as it effects the current folder
#
# Also note that this version of the API uses "processed data".  A better API would
